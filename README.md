# Домашние задания по модулю "Ручное тестирование веб-приложений"

В этом репозитории расположены домашние задания к каждой лекции.

1. Введение в тестирование ПО. Методы и виды тестирования
   * [Описание задания](https://github.com/netology-code/iqa-homeworks/tree/iqa-64/hw-1)
...
2. Тестирование ПО. Тест-дизайн
   * [Описание задания](https://github.com/netology-code/iqa-homeworks/tree/iqa-64/hw-4/)
...
3. Артефакты тестирования. Тестовая документация
   * [Описание задания](https://github.com/netology-code/iqa-homeworks/tree/iqa-64/hw-6)
